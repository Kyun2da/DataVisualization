function dashboard(id, fData) {
  var barColor = "#4B1D43";
  function segColor(c) {
    return { man: "steelblue", woman: "#EE8F5B" }[c];
  }
...
var freqData = [
  { State: "흉기", freq: { man: 30, woman: 20 } },
  { State: "목졸림", freq: { man: 30, woman: 11 } },
  { State: "둔기", freq: { man: 16, woman: 20 } },
  { State: "총살", freq: { man: 17, woman: 21 } },
  { State: "독살", freq: { man: 16, woman: 2 } },
  { State: "낙사", freq: { man: 8, woman: 8 } },
  { State: "익사", freq: { man: 2, woman: 7 } },
  { State: "폭팔", freq: { man: 3, woman: 2 } },
  { State: "질식", freq: { man: 3, woman: 2 } },
  { State: "감전", freq: { man: 1, woman: 1 } }
];
dashboard("#section-7-chart", freqData);
